...
public class VoucherController {
    ...
    ResponseEntity<Object> getDetailVoucher(HttpServletRequest request, HttpServletResponse response,
        ...
        VoucherResponse voucherResponse = VoucherMapper.convertVouchertoVoucherResponseFull(
    ...
    ResponseEntity<Object> getListVoucher(HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        List<VoucherResponse> voucherResponses =voucherService.getListVoucher(userId).stream().map(VoucherMapper::convertVouchertoVoucherResponseFull).collect(Collectors.toList());
        return ResponseEntity.ok().body(
                new StandardResponse<Object>(
                        StatusResponse.SUCCESSFUL,
                        "Found!!",
